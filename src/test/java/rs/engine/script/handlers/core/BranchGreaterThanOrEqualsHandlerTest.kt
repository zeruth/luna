...
class BranchGreaterThanOrEqualsHandlerTest {

    private val handler = BranchGreaterThanOrEqualsHandler()

    private val opcode = RuneScriptOpcode.BRANCH_GREATER_THAN_OR_EQUALS
